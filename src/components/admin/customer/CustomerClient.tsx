    ...
    <div>
            ...
            {loading ? (
              ...
              <tr>
                <td colSpan={5} className="px-4 py-12 text-center">
                  ...
                  <p className="text-gray-400">No customer found</p>
                </td>
              </tr>
            ) : (
              users.map((user) => (
      ...
      {activeUser && (
        <DeleteModal
          isOpen={!!activeUser}
          title="Delete customer"
          text={`Are you sure you want to delete this customer "${activeUser.name || activeUser.username}" ?`}
