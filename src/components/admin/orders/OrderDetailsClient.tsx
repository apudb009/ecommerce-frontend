...
import { Order, OrderStatus, Tracking, UserPermission } from '@/lib/types';
...
export default function OrderDetailsClient({ order: initialOrder, tracking, permissions }: Props) {
  const {
