...
type Props = {
  overview: OverviewAnalitics;
  revenueData: RevenuAnalitics[];
  ordersData: OrderAnalitics[];
  statusData: OrderStatusAnalitics[];
  topProducts: TopProducts[];
  catData: TopCategories[];
  usersData: UsersAnalitics[];
  lowStock: ProductLowStock[];
  recentOrders: RecentOrder[];
  ratedProducts: MostRatedProducts[];
};
